...
public class ProfileFragment extends Fragment {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (users.getImgUri().equals("default")) {
                    ...
                    Glide.with(getContext()).load(users.getImgUri()).into(imageView);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == GALLERY_CODE && resultCode == RESULT_OK) {
            ...
            ((StorageReference) reference).putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                @Override
