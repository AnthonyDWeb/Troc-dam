...
import static com.dam.troc.R.id.editTextTextProfilcPostal;
...
public class EditProfil extends AppCompatActivity {
    ...
    ImageView profilimg;
    Uri imgUrl;
    EditText plPseudo, plNom, plPrenom, plMel, plTel, plAdress, plVille, plCpostal, plComp1, plComp2,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        plPseudo = findViewById(R.id.editTextTextProfilPseudo);
        ...
        plAdress = findViewById(R.id.editTextTextProfilAdress);
        plVille = findViewById(R.id.editTextTextProfilVille);
        plCpostal = findViewById(editTextTextProfilcPostal);
    ...
    private void saveUserInformation() {
        ...
        if (displayComp1.isEmpty()) {
            plComp1.setError("Champs obligatoire");
            plComp1.requestFocus();
            return;
        }
        if (displayComp2.isEmpty()) {
            plComp2.setError("Champs obligatoire");
            plComp2.requestFocus();
            return;
        }
        if (displayComp3.isEmpty()) {
            plComp3.setError("Champs obligatoire");
            plComp3.requestFocus();
            return;
        }
        if (displayDesc.isEmpty()) {
            plDescription.setError("Champs obligatoire");
            plDescription.requestFocus();
            return;
        }
